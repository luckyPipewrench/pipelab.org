...
summary: "Snyk found 283 ClawHub skills leaking API keys and passwords through the LLM context window. VirusTotal's static scanning can't catch runtime exfiltration. Here's what can."
